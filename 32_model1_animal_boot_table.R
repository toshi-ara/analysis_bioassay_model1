...
load("rda/model1_animal_probit_boot.RData")
...
save(res_boot_plot, file = "rda/model1_animal_probit_boot_params.RData")
...
write_csv(tbl_boot_param, file = "csv/model1_parameters_boot_params.csv")
