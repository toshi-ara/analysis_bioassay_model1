...
glm_probit_M <- function(x, ...) {
    glmrob(response ~ logDose, family = binomial("probit"), data = x, ...)
}
...
save(res_boot, file = "rda//model1_animal_probit_robust_boot.RData")
